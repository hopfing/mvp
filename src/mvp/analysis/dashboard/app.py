...
from mvp.analysis.dashboard import bets, edge, execution, explorer, health, odds, overview, sharpness
...
PAGE_REGISTRY: list[dict] = [
    ...
    {"name": "Model Performance", "icon": "graph-up", "render": explorer.render},
